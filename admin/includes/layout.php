...
<html>
	<head>
		...
		<?php endif; ?>
		<meta name="generator" content="<?php echo $layoutContext->getGlobalConfig()->getCmsFullname(); ?>" />
	...
	<body>
		<header>
			...
			<nav class="main-menu">
				...
				<?php foreach ($layoutContext->getMenuItems() as $item) : ?>
					<li>
						<a href="<?php echo $item->getUrl(); ?>"<?php if ($item->hasTitle()) : ?> title="<?php echo $item->getHoverTitle(); ?>"<?php endif; ?><?php if ($item->isCurrent()) : ?> class="current"<?php endif; ?>><?php echo $item->getTitle(); ?></a>
						<?php if ($item->hasChild()) : ?>
						<ul class="sub-menu">
							<?php foreach ($item->getChildren() as $child) : ?>
								<li><a href="<?php echo $child->getUrl(); ?>"<?php if ($child->hasTitle()) : ?> title="<?php echo $child->getHoverTitle(); ?>"<?php endif; ?><?php if ($child->isCurrent()) : ?> class="current"<?php endif; ?>><?php echo $child->getTitle(); ?></a><li>
							<?php endforeach; ?>
						</ul>
						<?php endif; ?>
					</li>
			...
			<nav class="current-sub-menu">
				<ul>
					<?php foreach ($item->getCurrentSubMenuItems() as $currentSubItem) : ?>
						<li><a href="<?php echo $currentSubItem->getUrl(); ?>"<?php if ($currentSubItem->hasTitle()) : ?> title="<?php echo $currentSubItem->getHoverTitle(); ?>"<?php endif; ?><?php if ($currentSubItem->isCurrent()) : ?> class="current"<?php endif; ?>><?php echo $currentSubItem->getTitle(); ?></a><li>
					<?php endforeach; ?>
				</ul>
				<?php endif; ?>
			</nav>
		...
		<footer>
			...
			<?php else : ?>
				&copy; <?php echo date('Y'); ?> Copyright - Managed and generated by <a href="<?php echo $layoutContext->getGlobalConfig()->getCmsUrl(); ?>"><?php echo $layoutContext->getGlobalConfig()->getCmsFullname(); ?></a>.
			<?php endif; ?>
		</footer>
	</body>
</html>