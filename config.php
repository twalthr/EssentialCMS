...
define('MODULES_SECTION_GLOBAL_PRE_CONTENT', 1);
define('MODULES_SECTION_GLOBAL_CONTENT', 2);
define('MODULES_SECTION_GLOBAL_ASIDE_CONTENT', 4);
define('MODULES_SECTION_GLOBAL_POST_CONTENT', 8);
define('MODULES_SECTION_GLOBAL_LOGO', 16);
define('MODULES_SECTION_GLOBAL_ASIDE_HEADER', 32);
define('MODULES_SECTION_GLOBAL_FOOTER', 64);
define('MODULES_SECTION_PRE_CONTENT', 128);
define('MODULES_SECTION_CONTENT', 256);
define('MODULES_SECTION_ASIDE_CONTENT', 512);
define('MODULES_SECTION_POST_CONTENT', 1024);
