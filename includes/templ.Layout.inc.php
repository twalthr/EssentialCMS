...
<html>
	...
	<body>
		...
		<footer>
			...
			<?php else : ?>
				&copy; <?php echo date('Y'); ?> Copyright - Managed and generated by <a href="<?php echo $layoutContext->getConfig()->getCmsUrl(); ?>"><?php echo $layoutContext->getGlobalConfig()->getCmsFullname(); ?></a>.
			<?php endif; ?>
		</footer>
	</body>
</html>